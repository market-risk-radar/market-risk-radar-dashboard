...
app/
  ...
  page.tsx                  # Overview — A 성과 + A/B/KOSPI NAV 차트 + 60일 누적/초과수익률 요약(표본 일수 포함) + B 요약 + G1~G6 패널
...
3. 60일 누적수익률 요약: A/B/KOSPI 3개 카드 + 표본 일수
4. 60일 초과수익률 요약: A-KOSPI, B-KOSPI 2개 카드 + 표본 일수
